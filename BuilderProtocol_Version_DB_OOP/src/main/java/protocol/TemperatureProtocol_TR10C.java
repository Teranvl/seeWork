...
public class TemperatureProtocol_TR10C extends ThermoResistanceProtocol{


    public TemperatureProtocol_TR10C(ReadDataBase readDataBase, ParserRTF parserRTF, int protocolScopeNumber) {
