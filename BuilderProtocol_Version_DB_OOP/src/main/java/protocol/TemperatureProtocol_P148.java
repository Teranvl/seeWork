...
public class TemperatureProtocol_P148 extends ThermoResistanceProtocol{

    public TemperatureProtocol_P148(ReadDataBase readDataBase, ParserRTF parserRTF, int protocolScopeNumber) {
    ...
    public void calculation() {
        for (int i = 0; i < protocolPointsTable.size(); i++) { //вычисляем необходимые столбцы и добавляем в конец таблицы
            ...
            protocolPointsTable.get(i).add(calculation.calculationDmppForTemperatureP148(getStandard(i)));
