...
public class TemperatureProtocol_TC1288 extends ThermoResistanceProtocol {

    public TemperatureProtocol_TC1288(ReadDataBase readDataBase, ParserRTF parserRTF, int protocolScopeNumber) {
    ...
    public void calculation() {
        for (int i = 0; i < protocolPointsTable.size(); i++) { //вычисляем необходимые столбцы и добавляем в конец таблицы
            ...
            protocolPointsTable.get(i).add(calculation.calculationDmppForTemperatureTC1288(getStandard(i)));
